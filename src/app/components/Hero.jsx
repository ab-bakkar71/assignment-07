    ...
    return (
        <div>
            ...
            <section className='grid grid-cols-1 md:grid-cols-2 rounded-lg lg:grid-cols-4 gap-6 mb-10'>
                ...
                {/*stats card 2 */}
                <div className='p-8 shadow text-center '>
                    <h4 className='text-[32px] text-emerald-900 font-semibold'>3</h4>
                    <p className='text-[18px] text-slate-500'>On Track</p>
                </div>

                {/*stats card 3 */}
                <div className='p-8 shadow text-center '>
                    <h4 className='text-[32px] text-emerald-900 font-semibold'>6</h4>
                    <p className='text-[18px] text-slate-500'>Need Attention</p>
                </div>

                {/*stats card 4 */}
                <div className='p-8 shadow text-center '>
                    <h4 className='text-[32px] text-emerald-900 font-semibold'>12</h4>
